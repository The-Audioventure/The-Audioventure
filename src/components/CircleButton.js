...
export default class CircleButton extends React.Component {
	...
	fillRectangle = (iteration, starting) => {
		...
		return <View key={key} style={{ ...this.baseRectangleStyle, ...size, ...location }}></View>;
	};
	...
	render() {
		...
		return (
			<View style={localStyles.container}>
				<TouchableOpacity activeOpacity={0.2} style={localStyles.button} onPress={this.props.onPress}>
					{this.props.children}
				</TouchableOpacity>
