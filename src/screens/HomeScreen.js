...
const HomeScreen = ({ navigation }) => {
	...
	// );
	var song_uris = [];
	Object.values(AppConstants.themePlaylists).forEach((playlist) => {
	...
	const [assets] = useAssets([
		...
		...song_uris,
		AppConstants.backHomeIcon.src.uri,
	]);
		...
		<ViewContainer color={AppConstants.backgroundColor} height="100%" width="100%">
			{Platform.OS === 'web' ? (
				<Helmet>
					...
					<meta
						property="og:image"
						content="https://yahtzeerage.github.io/CYOA-Assets/assets/031_cover_kstr2.png"
						data-react-helmet="true"
					/>
					<meta
						property="og:url"
			...
			>
				<StyledBackground
					...
					width={scaledImageDim.width}
				>
					<ViewContainer start nudge color="clear" height="84.5%" width="50%" top=".6%">
