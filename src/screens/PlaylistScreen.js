...
const PlaylistScreen = ({ navigation }) => {
  ...
  const scaled_timeStampFontSize =
    scaledImageDim.scalingRatio *
    AppConstants.TIME_STAMP_FONT_SIZE *
    MAGIC_SCALING_FACTOR;
  const scaled_timeStampLineHeight = scaled_timeStampFontSize * 1.15;
    ...
    >
      ...
      >
        <StyledMusicPlayer
          ...
          timeStampFontSize={scaled_timeStampFontSize}
          timeStampLineHeight={scaled_timeStampLineHeight}
          //hack
