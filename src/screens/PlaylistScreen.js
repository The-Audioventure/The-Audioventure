...
const PlaylistScreen = ({ navigation }) => {
	...
	const scaledButtonBorderWidth =
		scaledImageDim.scalingRatio * AppConstants.BUTTON_BORDER_WIDTH * MAGIC_SCALING_FACTOR;
	...
	const scaled_subtitleFontSize =
		scaledImageDim.scalingRatio * AppConstants.SUBTITLE_FONT_SIZE * MAGIC_SCALING_FACTOR;
	...
	const scaled_cloudTitleFontSize =
		scaledImageDim.scalingRatio * AppConstants.CLOUDS_TITLE_FONT_SIZE * MAGIC_SCALING_FACTOR;
	...
	return (
		<ViewContainer color={AppConstants.backgroundColor} height="100%" width="100%">
			{Platform.OS === 'web' ? (
				<Helmet>
					<meta property="og:title" content="The Audioventure" data-react-helmet="true" />
					<meta
						property="og:description"
						content="An interactive album where YOU get to choose what to listen to and where the story will take you."
						data-react-helmet="true"
					/>
					<meta property="og:image" content={IMAGE.src.uri} data-react-helmet="true" />
					<meta
						property="og:url"
						content="https://yahtzeerage.github.io/The-Audioventure"
						data-react-helmet="true"
					/>
				</Helmet>
			) : null}
			<StyledBackground image={IMAGE.src} height={scaledImageDim.height} width={scaledImageDim.width}>
				<StyledMusicPlayer
